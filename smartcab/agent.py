...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        self.template_Q = dict((action, 0.0) for action in self.valid_actions)

        for state_tuple in itertools.product(*self.featured_states):
    ...
    def choose_action(self, state):
        ...
        if not self.learning or random.random() <= self.epsilon:
            ...
            maxQ_value, maxQ_actions = self.get_maxQ(state)
